#!/usr/bin/env python
"""
Developer: Lucas v.d. Gouw, Thijn van Kempen
Version: 3.0
Description: This script reads a BLASTn result and the multi-fasta that was used for BLASTn,
...
- Gives the user the option to extract sequences from BLAST hits.

Usage: CEA004_Selected_sequences_based_on_BLAST_hits_V3.py
{blast_table} {fasta_input} {fasta_output} {blast_switch} {hits_switch}

Note: CEA004 does not work when no BLAST hits are found. Therefore, when using CEA004
in a CLC workflow, add dummy fasta file that secures a BLAST hit to your multifasta input.
"""
