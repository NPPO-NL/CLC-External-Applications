...
def main():
    ...
    tmp_files = "/home/molbio/CEA009_tmp/"
    fasta_dir = "/home/molbio/CEA009_tmp/fasta/"
    gff_dir = "/home/molbio/CEA009_tmp/gff/"
    mitos_out = "/home/molbio/CEA009_tmp/mitos/"
    tmp_output_paths = [fasta_dir, gff_dir, mitos_out]
    mitos_path = "/opt/MITOS/"
    mitos_ref = "/opt/MITOS/data/mitos1-refdata/"
    ...
    make_gbk(fasta_out, gff_out, output)
...
def run_mitos(fasta_folder, gff_folder, mitos_output, mitos_install, reference, genetic_table):
    ...
    for fasta in glob.glob(os.path.join(fasta_folder, '*.fa')):
        ...
        #os.system("./mitos_bash {} {} {} {} {}".format(mitos_install, fasta, genetic_table, mitos_output, reference))
        #subprocess.call('{}runmitos.py -i {} -c {} -o {} -r {}'.format(mitos_install, fasta, genetic_table, mitos_output, reference), shell=True)
...
def gff_copy(result_number, mitos_dir, gff_dir):
    ...
    os.system("cp /home/molbio/CEA009_tmp/mitos/result.gff {}result{}.gff".format(gff_dir, str(result_number)))
...
def make_gbk(fasta, gff, gbk):
    ...
    """
    cwd = os.getcwd()
    #os.chdir("/MolbioDataDrive/Scripts")
    os.system("python /MolbioDataDrive/Scripts/CEA011_gff_to_gbk.py {} {} {}".format(fasta, gff, gbk))
    os.chdir(cwd)
