...
def main():
    ...
    parser.add_argument("blast_table", help="")
    parser.add_argument("fasta_input", help="Fasta input file")
    parser.add_argument("fasta_output", help="Fasta output")
    parser.add_argument("blast_switch", help="For BLASTn use 'BLASTn' for BLASTx use 'BLASTx'")
    parser.add_argument("hits_switch", help="For hits sequences use 'hits' for non hit sequences use 'no_hits'")
