# CLC External Applications
This repository contains all the CLC External Applications (CEAs) used by the Netherlands Institute for Vectors, Invasive plants and Plant health (NIVIP). <br><br>

Together with the files from the pipeline repositoties these pipelines can be recreated:
